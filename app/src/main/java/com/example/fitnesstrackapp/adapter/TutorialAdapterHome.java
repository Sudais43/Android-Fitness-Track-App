package com.example.fitnesstrackapp.adapter;
...
import com.example.fitnesstrackapp.TutorialPlayback;
        ...
        public void setData(VideoYT videoYT) {
            ...
            rvContainer.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    ActivityOptionsCompat options = ActivityOptionsCompat.makeSceneTransitionAnimation((Activity) itemView.getContext(), ImageVideo,Title,Description);
